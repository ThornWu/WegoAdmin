    ...
    <div class="whole_container">
        <div class="table_container">
            <div class="table_title">
                <span class="chi_title">Deleted Location Info</span>
            </div>
                ...
                <%
                    ...
                    try {
                        if(venueid!=null){
                            ...
                            String sql="select * from venue where isused='False' limit "+(Integer.parseInt(page_num)-1)*100+",100";
                            psmt=conn.prepareStatement(sql);
                        }
                        ...
                        while(rs.next()){
                            %>
                                <tr class="main_table_content <%if(count%2==0){%>main_table_content_first<%}else{%>main_table_content_second<%}%>">
                                    ...
                                    <td><a href="javascript:" class="table_edit_button" onclick="recover('<%=rs.getString("venueid")%>')">[ Recover ]</a></td>
                                </tr>
                            <%
                            count++;
                        }
