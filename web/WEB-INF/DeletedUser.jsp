...
<html>
            ...
            <div class="table_container">
                ...
                <div class="table_link">
                    <div class="table_link_left">
                        ...
                        <button onclick="clear_search()" class="table_button">Clear</button>                    </div>
                </div>
                    ...
                    <%
                        ...
                        try {
                            if(userid!=null){
                                ...
                                String sql="select * from user where isused='False' limit "+(Integer.parseInt(page_num)-1)*100+",100";
                                psmt=conn.prepareStatement(sql);
                            }
                            ...
                            while(rs.next()){
                                %>
                                    <tr class="main_table_content <%if(count%2==0){%>main_table_content_first<%}else{%>main_table_content_second<%}%>">
                                        ...
                                        <td> <a href="javascript:" class="table_edit_button" onclick="recover('<%=rs.getString("userid")%>')">[ Recover ]</a></td>
                                    </tr>
                                <%
                                count++;
                            }
    ...
    <script>
        ...
        function jump_url(click_page){
            ...
            if(click_page>0){
                if(userid!=""){
                    parent.IframeMain.location.href ="/servlet/DeletedUserUI?page="+click_page+"&userid="+userid;
                }else{
                    parent.IframeMain.location.href ="/servlet/DeletedUserUI?page="+click_page;
                }
            }if(page!=""){
                if(reg.test(page)){
                    if(userid!=""){
